    ...
    return (
        <div className="min-h-[87vh] content-center p-4">
            <div className="max-w-lg mx-auto card bg-base-100 shadow-xl border border-base-300">
                         ...
                         <div className="w-32 h-32 rounded-lg ring ring-primary ring-offset-base-100 ring-offset-2">
                            {user?.photoURL ? (
                                <img src={user.photoURL} alt="profile" className="rounded-lg object-cover" />
                                 ...
                                 <div className="flex items-center justify-center h-full bg-base-200 text-base-content/20">
                ...
                {/* Bottom Status Bar */}
                <div className="p-4 bg-base-200/50 border-t border-base-300 text-center rounded-b-xl">
